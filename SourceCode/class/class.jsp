...
rs=stmt.executeQuery("select * from class where xuehao='"+username+"'");
%>
      ...
      <td width="729" height="391"><form name="form1" method="post" action="editdo.jsp">
        <table width="100%" border="1">
          <tr>
            ...
            <td width="21%" rowspan="5"><img src="classphoto/<%=session.getAttribute("photo")%>" width="123" height="140"></td>
          </tr>
          <tr>
            <td width="10%">学号</td>
            <td width="28%"><FONT class=t4>
              
              <input name="xuehao" type="text" id="xuehao" readonly="true" value="<%=rs.getString("xuehao")%>">
            </FONT></td>
            <td width="13%">姓名</td>
            <td width="28%"><FONT class=t4>
          ...
          <tr>
            ...
            <td>出生年份</td>
            <td><FONT class=t4>
              <input name="chusheng" type="text" id="chusheng" value="<%=rs.getString("birthday")%>">
            </FONT></td>
          </tr>
