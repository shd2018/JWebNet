...
<table width="963" height="19" border="0">
           <tr>
             ...
             <td><span class="STYLE28">提问时间/回复老师</span></td>
             <td></td></tr> <%rs=stmt.executeQuery("select * from question where awser!='' and xuehao='"+xuehao+"'");
...
%>
            <tr>
              ...
              <td width="313" height="32" class="o"><span class="STYLE15"><%=namee%></span></td><td width="180"><%=rs.getString(5)%>/<a href="teacherinfo.jsp?gonghao=<%=rs.getString(7)%>" ><%=rs.getString(7)%></a></td>
              <td class="o"><a href="#"><span class="STYLE37">右边回答结果</span></a><%=rs.getString(6)%></td>
            </tr>
            <%if(rs.next()){
i++;}else{break;}
}
