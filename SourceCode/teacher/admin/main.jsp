...
border=0 >
  ...
  <TR class=tr_southidc>
    <TD width="48%" height=23>工号：<FONT class=t4><%=session.getAttribute("gonghao")%></FONT></TD>
  ...
  <table width="96%">
    <tr>
      <td width="656" height="391"><table width="99%" border="1">
        <tr>
          <td colspan="4" bgcolor="#CEEFFF"><div align="center" class="STYLE3">教师基本信息</div></td>
          <td width="21%" rowspan="6"><img src="../teacherphoto/<%=session.getAttribute("photo")%>" width="123" height="140"></td>
        </tr>
        <tr>
          <td width="10%">工号</td>
          <td width="20%"><FONT class=t4><%=session.getAttribute("gonghao")%></FONT></td>
          <td width="19%">姓名</td>
          <td width="30%"><FONT class=t4><%=session.getAttribute("name")%></FONT></td>
        </tr>
        <tr>
          <td>性别</td>
          <td><FONT class=t4><%=session.getAttribute("sex")%></FONT></td>
          <td>出生年份</td>
          <td><FONT class=t4><%=session.getAttribute("chusheng")%></FONT></td>
        </tr>
        <tr>
          <td>学位</td>
          <td><FONT class=t4><%=session.getAttribute("xuewei")%></FONT></td>
          <td>职称</td>
          <td><FONT class=t4><%=session.getAttribute("zhicheng")%></FONT></td>
        </tr>
        <tr>
          <td>特殊身份</td>
          <td><FONT class=t4><%=session.getAttribute("teshu")%></FONT></td>
          <td>Email</td>
        ...
        <tr>
          ...
          <td>手机</td>
          <td><FONT class=t4><%=session.getAttribute("shouji")%></FONT></td>
        </tr>
        <tr>
