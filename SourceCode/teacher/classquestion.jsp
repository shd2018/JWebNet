...
<body>
<table width="703" height="19" border="0">
...
%>
            <tr>
              ...
              <td width="223" height="32" class="o"><a href="list.jsp?id=<%=rowid%>" ><span class="STYLE15"><%=namee%></span></td>
              <td class="o"><a href="list.jsp?id=<%=rowid%>" ><span class="STYLE37">单击查看详细信息</span></a></td>
            </tr>
            <%if(rs.next()){
i++;}else{break;}
}
