...
<%
String gonghao=(String)session.getAttribute("gonghao");if(gonghao==null){response.sendRedirect("/");}
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    <TD id=frmTitle vAlign=center noWrap align=middle><IFRAME id=carnoc 
      ...
      name=carnoc src="admin/LeftTree.htm" frameBorder=0 
      scrolling=no>
    </IFRAME></TD>
    ...
    <TD style="WIDTH: 100%"><IFRAME id=main 
      ...
      name=main src="admin/main.jsp" frameBorder=0 
