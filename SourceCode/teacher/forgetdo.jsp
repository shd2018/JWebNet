...
rs=stmt.executeQuery("select * from teacher where gonghao='"+gonghao+"' and name='"+name+"' and email='"+email+"'");
...
out.println("找回成功!");
out.println("工号：   "+rs.getString(2)+"   密码 :  "+rs.getString(3)+"          <h1>请妥善保管</h1>");
