      ...
      <tbody>
        ...
        <tr>
          <td align="middle"><DIV align=center>
            <form action="kejiando.jsp" 
      method="post" enctype="multipart/form-data" name="form" id="form" onSubmit="return check_form()">
              <table style="BORDER-COLLAPSE: collapse" bordercolor="#FAC2DD" cellspacing="0" 
      cellpadding="3" width="700" bgcolor="#FFFFFF">
                <tbody>
                  <tr>
                    <td colspan="3" 
            height="27"><div align="left">课件发布
                  ...
                  <tr>
                    ...
                    <td width="83%" colspan="2"><div align="left">
                      <input name="Username" readonly="true" class="formstyle" value="<%=session.getAttribute("gonghao")%>"  size="22"/>
                    </div></td>
                  </tr>
                  ...
                  <tr>
                    <td height="21" align="right">课件名:</td>
                    <td colspan="2"><input 
            name="name" type="text" class="formstyle" id="name" size="22" />
                    <font color="#ff0000">＊必填 如，熊猫烧香专杀工具</font></td>
                  </tr>
                  <tr>
                    <td align="right" width="17%">&nbsp;</td>
                    <td colspan="2">&nbsp;</td>
                  ...
                  <tr>
                    <td align="right" width="17%">课件介绍：</td>
