...
function check_form(){
    ...
    var check_Username = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890";
        ...
        {
		alert("工号名只能由字母和数字构成，长度在4-15位之间。");
		document.form.Username.focus();
		return false;
    	}
...
if (form.Tel.value=="")
		{
			alert ("对不起，请输入您的电话，已方便学生与您好联系!");
			form.Tel.focus();
			return false;
		}
		if (form.shouji.value=="")
		{
			alert ("对不起，请输入您的手机号！");
			form.shouji.focus();
			return false;
